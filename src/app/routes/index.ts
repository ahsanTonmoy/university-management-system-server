...
import { semesterRegRoutes } from '../modules/semester/semesterReg.routes';
import { OfferedCourseRoutes } from '../modules/offerdCourses/offeredCourse.route';
